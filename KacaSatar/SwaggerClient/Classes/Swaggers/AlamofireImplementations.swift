    ...
    fileprivate func processRequest(request: DataRequest, _ managerId: String, _ completion: @escaping (_ response: Response<T>?, _ error: Error?) -> Void) {
        ...
        case is BasicFeatures.Type:
            validatedRequest.responseData { (dataResponse) in
                ...
                do {
                    ...
                    let basicFeaturesArray = try decoder.decode([BasicFeature].self, from: dataResponse.data!)

                    let successResponse = Response<[BasicFeature]>(response: dataResponse.response!, body: basicFeaturesArray)

                    completion(successResponse as? Response<T>, nil)
                } catch {
                    completion(nil, ErrorResponse.error(500, dataResponse.data, error))
                }
            }
        case is [Int].Type:
            validatedRequest.responseData { (dataResponse) in
                ...
                do {
                    let decoder = JSONDecoder()
                    let basicFeaturesArray = try decoder.decode([Int].self, from: dataResponse.data!)

                    let successResponse = Response<[Int]>(response: dataResponse.response!, body: basicFeaturesArray)
        ...
        case is Trims.Type:
            validatedRequest.responseData { (dataResponse) in
                ...
                do {
                    let decoder = JSONDecoder()
                    let basicFeaturesArray = try decoder.decode(Trims.self, from: dataResponse.data!)

                    let successResponse = Response<Trims>(response: dataResponse.response!, body: basicFeaturesArray)
        ...
        case is PriceResult.Type:
            validatedRequest.responseData { (dataResponse) in
                ...
                do {
                    let decoder = JSONDecoder()
                    let basicFeaturesArray = try decoder.decode(PriceResult.self, from: dataResponse.data!)

                    let successResponse = Response<PriceResult>(response: dataResponse.response!, body: basicFeaturesArray)
